    ...
    <div className="from-selection">
      <Dropdown
        title={
          <div className="swap-dropdown-item">
            <img className="swap-dropdown-item-img" src={getActiveIcon()} alt={selectedAsset} />
      ...
      >
        <Dropdown.Item eventKey={SWAP_ASSET.LBTC} onSelect={onSelectAsset}>
          {
            <div className="swap-dropdown-item">
              <img className="swap-dropdown-item-img" src={lbtcImage} style={{ height: "1.65rem" }} alt={SWAP_ASSET.LBTC} />
