...
import { useBtcPriceContext, useChartsContext, usePoolContext } from '../../context';
  ...
  if (pool === undefined || charts === undefined) {
    ...
    const price =
      pool.quote.assetHash === lbtcAsset.assetHash
        ? calculateUsdtPrice(btcPrice || 0, data?.price.todayValue || pool.tokenPrice)
        : data?.price.todayValue || Number(pool.tokenPrice);
    return (
            ...
            <div className="pool-summary-pooled-asset-palegreen-container">
              ...
              <div className="pool-summary-box-container">
                ...
                <span className="pool-summary-box-value">
                  <div className={`token-item pool-card-${data?.price.rate.direction}-text`}>
