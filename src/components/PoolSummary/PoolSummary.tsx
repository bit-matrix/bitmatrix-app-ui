    ...
    return (
      <div className="pool-summary-container">
        <div className="pool-summary-black-container">
          <div className="pool-summary-palegreen-container">
            <Svg
              className="pool-summary-box-icon"
            ...
            <div className="pool-summary-lbtc-container">
              <LbtcIcon className="pool-summary-lbtc-icon" width="3.5rem" height="2.5rem" />
              <span className="pool-summary-lbtc-value">
                {quoteAmountRound(Number(pool.quote.value) / payloadData.preferred_unit.value)}
              </span>
            </div>

            <div className="pool-summary-tether-container">
              <TetherIcon className="pool-summary-tether-icon" width="3.5rem" height="2.5rem" />
              <span className="pool-summary-tether-value">
        ...
        <div className="pool-summary-pool-metrics-container">
          <div className="pool-summary-price-container">
            ...
            <div className="pool-summary-value">${data.todayPrice.toLocaleString()}</div>
            <div className="pool-summary-icon-content">
              <span className="pool-summary-arrow">{data.priceRate.icon}</span>
              <span className={`pool-summary-arrow-${data.priceRate.direction}-text`}>{data.priceRate.value}%</span>
            </div>
          </div>

          <div className="pool-summary-volume-container">
            <div className="pool-summary-title">Volume 24h</div>
            <div className="pool-summary-value">${Numeral(data.todayVolumeData.close).format('(0.00a)')}</div>
            <div className="pool-summary-icon-content">
              <span className="pool-summary-arrow">{data.volumeRate.icon}</span>
              <span className={`pool-summary-arrow-${data.volumeRate.direction}-text`}>{data.volumeRate.value}%</span>
            </div>
          </div>

          <div className="pool-summary-tvl-container">
            <div className="pool-summary-title">TVL</div>
            <div className="pool-summary-value">${Numeral(data.todayTvlData).format('(0.00a)')}</div>
            <div className="pool-summary-icon-content">
              <span className="pool-summary-arrow">{data.tvlRate.icon}</span>
              <span className={`pool-summary-arrow-${data.tvlRate.direction}-text`}>{data.tvlRate.value}%</span>
            </div>
          </div>

          <div className="pool-summary-fees-container">
            <div className="pool-summary-title">Fees 24h</div>
            <div className="pool-summary-value">${Numeral(data.todayFeeData.close).format('(0.00a)')}</div>
            <div className="pool-summary-icon-content">
              <span className="pool-summary-arrow">{data.feeRate.icon}</span>
              <span className={`pool-summary-arrow-${data.feeRate.direction}-text`}>{data.feeRate.value}%</span>
            </div>
          </div>
        </div>
      </div>
